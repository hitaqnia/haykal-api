 ...
 * Every other environment — local, testing, staging, review apps — may opt in
 * with `OTP_FAKE=true`. The production check is deliberately not configurable:
 * a setting that can turn this back on in production would defeat the point of
 * having it.
 */
final class FakeOtp
{
